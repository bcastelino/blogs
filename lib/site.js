...
export const SITE_URL = 'https://bcastelino.github.io/blogs';
...
export const LOGO_URL = `${SITE_URL}/tbj-black-logo.png`;
export const DEFAULT_OG_IMAGE = `${SITE_URL}/brian-blogs.png`;
