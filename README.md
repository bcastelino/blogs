...
## �️ Want to run or fork it?

This repo is the full source of the site. If you'd like to run it locally, write posts,
or deploy your own copy, the complete reproduction guide lives in **[`SETUP.md`](./SETUP.md)**.
...
**The Brian Journal** - by [Brian Castelino](https://www.linkedin.com/in/cas7elino/)
